...
EXPECTATIONS = [
    ...
    ("secu_nm_kasasa_compare", "Kasasa Cash", "monthly_maintenance_fee", "None"),
    ("secu_nm_kasasa_compare", "Kasasa Cash Back", "monthly_maintenance_fee", "None"),
    ("secu_nm_kasasa_compare", "Kasasa Tunes", "monthly_maintenance_fee", "None"),
